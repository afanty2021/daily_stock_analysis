...
_CATEGORY_DEFINITIONS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "title": "AI Forecast",
        "description": "TimesFM time series forecasting configuration and ensemble settings.",
        "display_order": 25,
    },
    {
...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    # ------------------------------------------------------------------
    # TimesFM AI Forecast Configuration
    # ------------------------------------------------------------------
    "TIMESFM_ENABLED": {
        "title": "Enable TimesFM Forecast",
        "description": "Enable TimesFM AI model for stock price prediction (future 60 trading days). Requires ~1.5GB RAM. Default: false.",
        "category": "ai_forecast",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "TIMESFM_MODEL_ID": {
        "title": "TimesFM Model ID",
        "description": "Hugging Face model identifier for TimesFM. Default: google/timesfm-2.5-200m-pytorch",
        "category": "ai_forecast",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "google/timesfm-2.5-200m-pytorch",
        "options": [],
        "validation": {},
        "display_order": 101,
    },
    "TIMESFM_MAX_CONTEXT": {
        ...
        "description": "Maximum historical context length (0 = adaptive, up to 1024 trading days). More context = better accuracy but slower.",
        "category": "ai_forecast",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "default_value": "0",
        "options": [],
        "validation": {"min": 0, "max": 1024},
        "display_order": 102,
    },
    "TIMESFM_MAX_HORIZON": {
        "title": "Max Forecast Horizon",
        "description": "Maximum forecast horizon in trading days (1-120). Default: 60 days.",
        "category": "ai_forecast",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "TIMESFM_CACHE_DIR": {
        ...
        "description": "Custom directory for TimesFM model cache (empty = default HuggingFace cache). Useful for offline deployment.",
        "category": "ai_forecast",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "TIMESFM_DEVICE": {
        ...
        "description": "Device for TimesFM inference: auto (detect), cpu, or cuda (GPU).",
        "category": "ai_forecast",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
    ...
    "TIMESFM_USE_QUANTILE_HEAD": {
        "title": "Use Quantile Head",
        "description": "Enable continuous quantile head for confidence interval prediction (10%-90% percentiles). Recommended: true.",
        "category": "ai_forecast",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    # ------------------------------------------------------------------
    # TimesFM Covariates Configuration (Phase 2)
    # ------------------------------------------------------------------
    "TIMESFM_COVARIATES_ENABLED": {
        "title": "Enable Covariates (XReg)",
        "description": "Enable external covariates (volume, technical indicators) to improve prediction accuracy. Requires more data and computation. Default: false.",
        "category": "ai_forecast",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "TIMESFM_COVARIATE_FEATURES": {
        "title": "Covariate Features",
        "description": "Comma-separated list of covariate features to use. Available: volume_change, ma_deviation, rsi, bollinger_position. Default: volume_change,ma_deviation",
        "category": "ai_forecast",
        "data_type": "array",
        "ui_control": "textarea",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "volume_change,ma_deviation",
        "options": [
            {"label": "Volume Change", "value": "volume_change"},
            {"label": "MA Deviation", "value": "ma_deviation"},
            {"label": "RSI", "value": "rsi"},
            {"label": "Bollinger Position", "value": "bollinger_position"},
        ],
        "validation": {},
        "display_order": 108,
    },
    # ------------------------------------------------------------------
    # TimesFM Ensemble Configuration (Phase 2)
    # ------------------------------------------------------------------
    "TIMESFM_ENSEMBLE_ENABLED": {
        "title": "Enable Ensemble Forecast",
        "description": "Enable multi-model ensemble forecasting to improve prediction accuracy by combining TimesFM with simpler baseline models. Default: false.",
        "category": "ai_forecast",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "TIMESFM_ENSEMBLE_MODELS": {
        "title": "Ensemble Models",
        "description": "Comma-separated list of models to include in ensemble. Available: timesfm, naive_seasonal, moving_average. Default: timesfm,naive_seasonal,moving_average",
        "category": "ai_forecast",
        "data_type": "array",
        "ui_control": "textarea",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "timesfm,naive_seasonal,moving_average",
        "options": [
            {"label": "TimesFM (AI)", "value": "timesfm"},
            {"label": "Naive Seasonal", "value": "naive_seasonal"},
            {"label": "Moving Average", "value": "moving_average"},
        ],
        "validation": {},
        "display_order": 110,
    },
    "TIMESFM_ENSEMBLE_STRATEGY": {
        "title": "Ensemble Strategy",
        "description": "How to combine predictions from ensemble models: simple_average (equal weight), weighted_average (TimesFM weighted higher), or median (robust to outliers). Default: weighted_average",
        "category": "ai_forecast",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "options": [
            {"label": "Simple Average", "value": "simple_average"},
            {"label": "Weighted Average (TimesFM priority)", "value": "weighted_average"},
    ...
    # ------------------------------------------------------------------
    # TimesFM Real-time Update Configuration (Phase 2)
    # ------------------------------------------------------------------
    "TIMESFM_REALTIME_UPDATE_ENABLED": {
        "title": "Enable Real-time Updates",
        "description": "Enable real-time prediction updates based on price changes and cache expiration. Reduces redundant computation while keeping predictions fresh. Default: false.",
        "category": "ai_forecast",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "TIMESFM_CACHE_TTL_MINUTES": {
        "title": "Cache TTL (Minutes)",
        "description": "Prediction cache time-to-live in minutes. Predictions are reused within this window unless price changes significantly. Default: 60 minutes.",
        "category": "ai_forecast",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "TIMESFM_UPDATE_ON_PRICE_CHANGE_PCT": {
        "title": "Update Trigger (Price Change %)",
        "description": "Price change threshold (percentage) that triggers cache invalidation. If price moves more than this, predictions refresh even if cache is valid. Default: 2.0%",
        "category": "ai_forecast",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
